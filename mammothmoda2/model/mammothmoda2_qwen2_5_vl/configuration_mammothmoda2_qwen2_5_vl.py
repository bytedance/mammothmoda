...
class Mammothmoda2Qwen2_5_VLTextConfig(PretrainedConfig):
    ...
    ```python
    >>> from transformers import Qwen2_5_VLTextModel, Mammothmoda2Qwen2_5_VLConfig

    >>> # Initializing a Qwen2_5_VL style configuration
    >>> configuration = Mammothmoda2Qwen2_5_VLConfig()
        ...
        **kwargs,
        ...
        if gen_vocab_start_index is None:
            if self.extra_gen_vocab:
                ...
                # NOTE: assume text vocab contains gen vocab in the end
...
class Mammothmoda2Qwen2_5_VLConfig(PretrainedConfig):
    ...
    Args:
        text_config (`Union[PreTrainedConfig, dict]`, *optional*, defaults to `Mammothmoda2Qwen2_5_VLTextConfig`):
            The config object or dictionary of the text backbone.
        vision_config (`Union[PreTrainedConfig, dict]`,  *optional*, defaults to `Mammothmoda2Qwen2_5_VLVisionConfig`):
    ...
    ```python
    >>> from transformers import Qwen2_5_VLForConditionalGeneration, Mammothmoda2Qwen2_5_VLConfig
...
__all__ = ["Mammothmoda2Qwen2_5_VLConfig", "Mammothmoda2Qwen2_5_VLTextConfig"]
